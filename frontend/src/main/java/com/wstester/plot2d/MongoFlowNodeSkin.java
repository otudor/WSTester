...
public class MongoFlowNodeSkin extends CustomFlowNodeSkinNew {

    public MongoFlowNodeSkin(FXSkinFactory skinFactory,
    ...
    protected Node createView() {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("MongoUI.fxml"));
