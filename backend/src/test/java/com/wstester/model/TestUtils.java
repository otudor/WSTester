...
public class TestUtils {
	...
	public static TestProject getDependantMockStepsPlan() throws JSONException {
		...
		Rule rule = new MongoRule(com.wstester.model.MongoRule.InputType.COLLECTION, "customer", "mockedResponse");
		ruleList.add(rule );
		service2.setRuleList(ruleList );
		serviceList2.add(service2);
